...
create definer = root@`%` view vwaccounttype_dede as
select `af_ukrc`.`tblaccounttype`.`AccountTypeId`            AS `AccountTypeId`,
       `af_ukrc`.`tblaccounttype`.`AuditFileNumber`          AS `AuditFileNumber`,
       `af_ukrc`.`tblaccounttype`.`AccountType`              AS `AccountType`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`AccountName` = '') or
           (`af_ukrc`.`tblaccounttype_lang`.`AccountName` is null)), `af_ukrc`.`tblaccounttype`.`AccountName`,
          `af_ukrc`.`tblaccounttype_lang`.`AccountName`)     AS `AccountName`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`AccountTypeName` = '') or
           (`af_ukrc`.`tblaccounttype_lang`.`AccountTypeName` is null)), `af_ukrc`.`tblaccounttype`.`AccountTypeName`,
          `af_ukrc`.`tblaccounttype_lang`.`AccountTypeName`) AS `AccountTypeName`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`AccountTypeDesc` = '') or
           (`af_ukrc`.`tblaccounttype_lang`.`AccountTypeDesc` is null)), `af_ukrc`.`tblaccounttype`.`AccountTypeDesc`,
          `af_ukrc`.`tblaccounttype_lang`.`AccountTypeDesc`) AS `AccountTypeDesc`,
       `af_ukrc`.`tblaccounttype`.`ParentId`                 AS `ParentId`,
       `af_ukrc`.`tblaccounttype`.`FolderCode`               AS `FolderCode`,
       `af_ukrc`.`tblaccounttype`.`LeadScheduleCode`         AS `LeadScheduleCode`,
       `af_ukrc`.`tblaccounttype`.`RowType`                  AS `RowType`,
       `af_ukrc`.`tblaccounttype`.`Formula`                  AS `Formula`,
       `af_ukrc`.`tblaccounttype`.`TotalAccountIds`          AS `TotalAccountIds`,
       `af_ukrc`.`tblaccounttype`.`OnlyTotalSelf`            AS `OnlyTotalSelf`,
       `af_ukrc`.`tblaccounttype`.`Rank`                     AS `Rank`,
       `af_ukrc`.`tblaccounttype`.`Nature`                   AS `Nature`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`FormulaName` = '') or
           (`af_ukrc`.`tblaccounttype_lang`.`FormulaName` is null)), `af_ukrc`.`tblaccounttype`.`FormulaName`,
          `af_ukrc`.`tblaccounttype_lang`.`FormulaName`)     AS `FormulaName`,
       `af_ukrc`.`tblaccounttype`.`AccountingStructureId`    AS `AccountingStructureId`
from (`af_ukrc`.`tblaccounttype` left join `af_ukrc`.`tblaccounttype_lang`
      on (((`af_ukrc`.`tblaccounttype`.`AccountTypeId` = `af_ukrc`.`tblaccounttype_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblaccounttype_lang`.`lang_code` = 'de-DE'))))
where (1 = 1);

create definer = root@`%` view vwaccounttype_enau as
select `af_ukrc`.`tblaccounttype`.`AccountTypeId`            AS `AccountTypeId`,
       `af_ukrc`.`tblaccounttype`.`AuditFileNumber`          AS `AuditFileNumber`,
       `af_ukrc`.`tblaccounttype`.`AccountType`              AS `AccountType`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`AccountName` = '') or
...
from (`af_ukrc`.`tblaccounttype` left join `af_ukrc`.`tblaccounttype_lang`
      on (((`af_ukrc`.`tblaccounttype`.`AccountTypeId` = `af_ukrc`.`tblaccounttype_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblaccounttype_lang`.`lang_code` = 'en-AU'))))
where (1 = 1);

create definer = root@`%` view vwaccounttype_engb as
select `af_ukrc`.`tblaccounttype`.`AccountTypeId`            AS `AccountTypeId`,
       `af_ukrc`.`tblaccounttype`.`AuditFileNumber`          AS `AuditFileNumber`,
       `af_ukrc`.`tblaccounttype`.`AccountType`              AS `AccountType`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`AccountName` = '') or
...
from (`af_ukrc`.`tblaccounttype` left join `af_ukrc`.`tblaccounttype_lang`
      on (((`af_ukrc`.`tblaccounttype`.`AccountTypeId` = `af_ukrc`.`tblaccounttype_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblaccounttype_lang`.`lang_code` = 'en-GB'))))
where (1 = 1);

create definer = root@`%` view vwaccounttype_frfr as
select `af_ukrc`.`tblaccounttype`.`AccountTypeId`            AS `AccountTypeId`,
       `af_ukrc`.`tblaccounttype`.`AuditFileNumber`          AS `AuditFileNumber`,
       `af_ukrc`.`tblaccounttype`.`AccountType`              AS `AccountType`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`AccountName` = '') or
...
from (`af_ukrc`.`tblaccounttype` left join `af_ukrc`.`tblaccounttype_lang`
      on (((`af_ukrc`.`tblaccounttype`.`AccountTypeId` = `af_ukrc`.`tblaccounttype_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblaccounttype_lang`.`lang_code` = 'fr-FR'))))
where (1 = 1);

create definer = root@`%` view vwaccounttype_nlnl as
select `af_ukrc`.`tblaccounttype`.`AccountTypeId`            AS `AccountTypeId`,
       `af_ukrc`.`tblaccounttype`.`AuditFileNumber`          AS `AuditFileNumber`,
       `af_ukrc`.`tblaccounttype`.`AccountType`              AS `AccountType`,
       if(((`af_ukrc`.`tblaccounttype_lang`.`AccountName` = '') or
...
from (`af_ukrc`.`tblaccounttype` left join `af_ukrc`.`tblaccounttype_lang`
      on (((`af_ukrc`.`tblaccounttype`.`AccountTypeId` = `af_ukrc`.`tblaccounttype_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblaccounttype_lang`.`lang_code` = 'nl-NL'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_cygb as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
       ifnull(`af_ukrc`.`tblafworkingpaperindex_lang`.`FormTitle`,
              `af_ukrc`.`tblafworkingpaperindex`.`FormTitle`)                                                      AS `FormTitle`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormType`                                                               AS `FormType`,
       `af_ukrc`.`tblafworkingpaperindex`.`Responsability`                                                         AS `Responsability`,
       `af_ukrc`.`tblafworkingpaperindex`.`Issues`                                                                 AS `Issues`,
       `af_ukrc`.`tblafworkingpaperindex`.`StepsTotal`                                                             AS `StepsTotal`,
       `af_ukrc`.`tblafworkingpaperindex`.`StepsCompleted`                                                         AS `StepsCompleted`,
       `af_ukrc`.`tblafworkingpaperindex`.`CompletedProgress`                                                      AS `CompletedProgress`,
       `af_ukrc`.`tblafworkingpaperindex`.`CompletedByStaffId`                                                     AS `CompletedByStaffId`,
       `af_ukrc`.`tblafworkingpaperindex`.`CompletedDate`                                                          AS `CompletedDate`,
       `af_ukrc`.`tblafworkingpaperindex`.`CompletedByStaff`                                                       AS `CompletedByStaff`,
       `af_ukrc`.`tblafworkingpaperindex`.`PreparedByStaffId`                                                      AS `PreparedByStaffId`,
       `af_ukrc`.`tblafworkingpaperindex`.`PreparedByStaff`                                                        AS `PreparedByStaff`,
       `af_ukrc`.`tblafworkingpaperindex`.`PreparedDate`                                                           AS `PreparedDate`,
       `af_ukrc`.`tblafworkingpaperindex`.`UpdatedByStaffId`                                                       AS `UpdatedByStaffId`,
       `af_ukrc`.`tblafworkingpaperindex`.`UpdatedByStaff`                                                         AS `UpdatedByStaff`,
       `af_ukrc`.`tblafworkingpaperindex`.`UpdatedDate`                                                            AS `UpdatedDate`,
       `af_ukrc`.`tblafworkingpaperindex`.`FirstReviewStaffId`                                                     AS `FirstReviewStaffId`,
       `af_ukrc`.`tblafworkingpaperindex`.`FirstReviewStaff`                                                       AS `FirstReviewStaff`,
       `af_ukrc`.`tblafworkingpaperindex`.`FirstReviewDate`                                                        AS `FirstReviewDate`,
       `af_ukrc`.`tblafworkingpaperindex`.`SecondReviewStaffId`                                                    AS `SecondReviewStaffId`,
       `af_ukrc`.`tblafworkingpaperindex`.`SecondReviewStaff`                                                      AS `SecondReviewStaff`,
       `af_ukrc`.`tblafworkingpaperindex`.`SecondReviewDate`                                                       AS `SecondReviewDate`,
       `af_ukrc`.`tblafworkingpaperindex`.`ReviewedByStaffId`                                                      AS `ReviewedByStaffId`,
       `af_ukrc`.`tblafworkingpaperindex`.`ReviewedByStaff`                                                        AS `ReviewedByStaff`,
       `af_ukrc`.`tblafworkingpaperindex`.`ReviewedDate`                                                           AS `ReviewedDate`,
       `af_ukrc`.`tblafworkingpaperindex`.`Hidden`                                                                 AS `Hidden`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormOrder`                                                              AS `FormOrder`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormId`                                                                 AS `FormId`,
       `af_ukrc`.`tblafworkingpaperindex`.`UploadedFileId`                                                         AS `UploadedFileId`,
       `af_ukrc`.`tblafworkingpaperindex`.`ParentId`                                                               AS `ParentId`,
       `af_ukrc`.`tblafworkingpaperindex`.`VersionNumber`                                                          AS `VersionNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormSource`                                                             AS `FormSource`,
       `af_ukrc`.`tblafworkingpaperindex`.`RevisionNumber`                                                         AS `RevisionNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`LatestRevisionDate`                                                     AS `LatestRevisionDate`,
       `af_ukrc`.`tblafworkingpaperindex`.`ExternalGuid`                                                           AS `ExternalGuid`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormView`                                                               AS `FormView`,
       `af_ukrc`.`tblafworkingpaperindex`.`ForceDisplay`                                                           AS `ForceDisplay`
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'cy-GB'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_czcz as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'cz-CZ'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_de as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'de'))))
where (1 = 1);


create definer = root@`%` view vwafworkingpaperindex_deat as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'de-AT'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_dech as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'de-CH'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_dede as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                         AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                    AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                            AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                           AS `FormCode`,
       if(((`af_ukrc`.`tblafworkingpaperindex_lang`.`FormTitle` = '') or
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`FormTitle` is null)),
          `af_ukrc`.`tblafworkingpaperindex`.`FormTitle`,
          `af_ukrc`.`tblafworkingpaperindex_lang`.`FormTitle`)                                                 AS `FormTitle`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormType`                                                           AS `FormType`,
       `af_ukrc`.`tblafworkingpaperindex`.`Responsability`                                                     AS `Responsability`,
       `af_ukrc`.`tblafworkingpaperindex`.`Issues`                                                             AS `Issues`,
       `af_ukrc`.`tblafworkingpaperindex`.`StepsTotal`                                                         AS `StepsTotal`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'de-DE'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_deli as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'de-LI'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_delu as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'de-LU'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_enau as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                         AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                    AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                            AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                           AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'en-AU'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_enau.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwafworkingpaperindex_engb as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                         AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                    AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                            AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                           AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'en-GB'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_frbe as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'fr-BE'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_frch as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'fr-CH'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_frfr as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                         AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                    AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                            AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                           AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'fr-FR'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_frlu as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'fr-LU'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_fynl as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'fy-NL'))))
where (1 = 1);


create definer = root@`%` view vwafworkingpaperindex_it as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'it'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_itch as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'it-CH'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_itit as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'it-IT'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_lblu as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'lb-LU'))))
where (1 = 1);

create definer = root@`%` view vwafworkingpaperindex_nlbe as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'nl-BE'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_nlbe.Responsability not supported: UserType

-- comment on column vwafworkingpaperindex_nlbe.CompletedByStaffId not supported: staff who has completed this WP

-- comment on column vwafworkingpaperindex_nlbe.CompletedDate not supported: completed date

-- comment on column vwafworkingpaperindex_nlbe.Hidden not supported: 1 = hidden, null or 0 = show

-- comment on column vwafworkingpaperindex_nlbe.FormId not supported: dbcontroller.tblformcontent.FormId

-- comment on column vwafworkingpaperindex_nlbe.UploadedFileId not supported: tblaffiles.UploadedFileId

-- comment on column vwafworkingpaperindex_nlbe.ParentId not supported: IndexRowId, or NULL if wpi section

-- comment on column vwafworkingpaperindex_nlbe.VersionNumber not supported: Overrides the version number of this form - otherwise version number is determined from the form's parent auditfile

-- comment on column vwafworkingpaperindex_nlbe.FormSource not supported: industry or firm, null = read tblauditfile TemplateType

-- comment on column vwafworkingpaperindex_nlbe.LatestRevisionDate not supported: The date that the latest revision to this workpaper was made

-- comment on column vwafworkingpaperindex_nlbe.FormView not supported: View name on the file system - to be used for static views

-- comment on column vwafworkingpaperindex_nlbe.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwafworkingpaperindex_nlnl as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                         AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                    AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                            AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                           AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'nl-NL'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_nlnl.Responsability not supported: UserType

-- comment on column vwafworkingpaperindex_nlnl.CompletedByStaffId not supported: staff who has completed this WP

-- comment on column vwafworkingpaperindex_nlnl.CompletedDate not supported: completed date

-- comment on column vwafworkingpaperindex_nlnl.Hidden not supported: 1 = hidden, null or 0 = show

-- comment on column vwafworkingpaperindex_nlnl.FormId not supported: dbcontroller.tblformcontent.FormId

-- comment on column vwafworkingpaperindex_nlnl.UploadedFileId not supported: tblaffiles.UploadedFileId

-- comment on column vwafworkingpaperindex_nlnl.ParentId not supported: IndexRowId, or NULL if wpi section

-- comment on column vwafworkingpaperindex_nlnl.VersionNumber not supported: Overrides the version number of this form - otherwise version number is determined from the form's parent auditfile

-- comment on column vwafworkingpaperindex_nlnl.FormSource not supported: industry or firm, null = read tblauditfile TemplateType

-- comment on column vwafworkingpaperindex_nlnl.LatestRevisionDate not supported: The date that the latest revision to this workpaper was made

-- comment on column vwafworkingpaperindex_nlnl.FormView not supported: View name on the file system - to be used for static views

-- comment on column vwafworkingpaperindex_nlnl.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwafworkingpaperindex_pl as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'pl'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_pl.Responsability not supported: UserType

-- comment on column vwafworkingpaperindex_pl.CompletedByStaffId not supported: staff who has completed this WP

-- comment on column vwafworkingpaperindex_pl.CompletedDate not supported: completed date

-- comment on column vwafworkingpaperindex_pl.Hidden not supported: 1 = hidden, null or 0 = show

-- comment on column vwafworkingpaperindex_pl.FormId not supported: dbcontroller.tblformcontent.FormId

-- comment on column vwafworkingpaperindex_pl.UploadedFileId not supported: tblaffiles.UploadedFileId

-- comment on column vwafworkingpaperindex_pl.ParentId not supported: IndexRowId, or NULL if wpi section

-- comment on column vwafworkingpaperindex_pl.VersionNumber not supported: Overrides the version number of this form - otherwise version number is determined from the form's parent auditfile

-- comment on column vwafworkingpaperindex_pl.FormSource not supported: industry or firm, null = read tblauditfile TemplateType

-- comment on column vwafworkingpaperindex_pl.LatestRevisionDate not supported: The date that the latest revision to this workpaper was made

-- comment on column vwafworkingpaperindex_pl.FormView not supported: View name on the file system - to be used for static views

-- comment on column vwafworkingpaperindex_pl.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwafworkingpaperindex_plpl as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'pl-PL'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_plpl.Responsability not supported: UserType

-- comment on column vwafworkingpaperindex_plpl.CompletedByStaffId not supported: staff who has completed this WP

-- comment on column vwafworkingpaperindex_plpl.CompletedDate not supported: completed date

-- comment on column vwafworkingpaperindex_plpl.Hidden not supported: 1 = hidden, null or 0 = show

-- comment on column vwafworkingpaperindex_plpl.FormId not supported: dbcontroller.tblformcontent.FormId

-- comment on column vwafworkingpaperindex_plpl.UploadedFileId not supported: tblaffiles.UploadedFileId

-- comment on column vwafworkingpaperindex_plpl.ParentId not supported: IndexRowId, or NULL if wpi section

-- comment on column vwafworkingpaperindex_plpl.VersionNumber not supported: Overrides the version number of this form - otherwise version number is determined from the form's parent auditfile

-- comment on column vwafworkingpaperindex_plpl.FormSource not supported: industry or firm, null = read tblauditfile TemplateType

-- comment on column vwafworkingpaperindex_plpl.LatestRevisionDate not supported: The date that the latest revision to this workpaper was made

-- comment on column vwafworkingpaperindex_plpl.FormView not supported: View name on the file system - to be used for static views

-- comment on column vwafworkingpaperindex_plpl.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwafworkingpaperindex_rmch as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'rm-CH'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_rmch.Responsability not supported: UserType

-- comment on column vwafworkingpaperindex_rmch.CompletedByStaffId not supported: staff who has completed this WP

-- comment on column vwafworkingpaperindex_rmch.CompletedDate not supported: completed date

-- comment on column vwafworkingpaperindex_rmch.Hidden not supported: 1 = hidden, null or 0 = show

-- comment on column vwafworkingpaperindex_rmch.FormId not supported: dbcontroller.tblformcontent.FormId

-- comment on column vwafworkingpaperindex_rmch.UploadedFileId not supported: tblaffiles.UploadedFileId

-- comment on column vwafworkingpaperindex_rmch.ParentId not supported: IndexRowId, or NULL if wpi section

-- comment on column vwafworkingpaperindex_rmch.VersionNumber not supported: Overrides the version number of this form - otherwise version number is determined from the form's parent auditfile

-- comment on column vwafworkingpaperindex_rmch.FormSource not supported: industry or firm, null = read tblauditfile TemplateType

-- comment on column vwafworkingpaperindex_rmch.LatestRevisionDate not supported: The date that the latest revision to this workpaper was made

-- comment on column vwafworkingpaperindex_rmch.FormView not supported: View name on the file system - to be used for static views

-- comment on column vwafworkingpaperindex_rmch.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwafworkingpaperindex_sk as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'sk'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_sk.Responsability not supported: UserType

-- comment on column vwafworkingpaperindex_sk.CompletedByStaffId not supported: staff who has completed this WP

-- comment on column vwafworkingpaperindex_sk.CompletedDate not supported: completed date

-- comment on column vwafworkingpaperindex_sk.Hidden not supported: 1 = hidden, null or 0 = show

-- comment on column vwafworkingpaperindex_sk.FormId not supported: dbcontroller.tblformcontent.FormId

-- comment on column vwafworkingpaperindex_sk.UploadedFileId not supported: tblaffiles.UploadedFileId

-- comment on column vwafworkingpaperindex_sk.ParentId not supported: IndexRowId, or NULL if wpi section

-- comment on column vwafworkingpaperindex_sk.VersionNumber not supported: Overrides the version number of this form - otherwise version number is determined from the form's parent auditfile

-- comment on column vwafworkingpaperindex_sk.FormSource not supported: industry or firm, null = read tblauditfile TemplateType

-- comment on column vwafworkingpaperindex_sk.LatestRevisionDate not supported: The date that the latest revision to this workpaper was made

-- comment on column vwafworkingpaperindex_sk.FormView not supported: View name on the file system - to be used for static views

-- comment on column vwafworkingpaperindex_sk.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwafworkingpaperindex_sksk as
select `af_ukrc`.`tblafworkingpaperindex`.`IndexRowId`                                                             AS `IndexRowId`,
       `af_ukrc`.`tblafworkingpaperindex`.`AuditFileNumber`                                                        AS `AuditFileNumber`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormRef`                                                                AS `FormRef`,
       `af_ukrc`.`tblafworkingpaperindex`.`FormCode`                                                               AS `FormCode`,
...
from (`af_ukrc`.`tblafworkingpaperindex` left join `af_ukrc`.`tblafworkingpaperindex_lang`
      on (((`af_ukrc`.`tblafworkingpaperindex`.`IndexRowId` = `af_ukrc`.`tblafworkingpaperindex_lang`.`IndexRowId`) and
           (`af_ukrc`.`tblafworkingpaperindex_lang`.`lang_code` = 'sk-SK'))))
where (1 = 1);

-- comment on column vwafworkingpaperindex_sksk.Responsability not supported: UserType

-- comment on column vwafworkingpaperindex_sksk.CompletedByStaffId not supported: staff who has completed this WP

-- comment on column vwafworkingpaperindex_sksk.CompletedDate not supported: completed date

-- comment on column vwafworkingpaperindex_sksk.Hidden not supported: 1 = hidden, null or 0 = show

-- comment on column vwafworkingpaperindex_sksk.FormId not supported: dbcontroller.tblformcontent.FormId

-- comment on column vwafworkingpaperindex_sksk.UploadedFileId not supported: tblaffiles.UploadedFileId

-- comment on column vwafworkingpaperindex_sksk.ParentId not supported: IndexRowId, or NULL if wpi section

-- comment on column vwafworkingpaperindex_sksk.VersionNumber not supported: Overrides the version number of this form - otherwise version number is determined from the form's parent auditfile

-- comment on column vwafworkingpaperindex_sksk.FormSource not supported: industry or firm, null = read tblauditfile TemplateType

-- comment on column vwafworkingpaperindex_sksk.LatestRevisionDate not supported: The date that the latest revision to this workpaper was made

-- comment on column vwafworkingpaperindex_sksk.FormView not supported: View name on the file system - to be used for static views

-- comment on column vwafworkingpaperindex_sksk.ForceDisplay not supported: This is to indicate that a folder or workpaper should be permanently display

create definer = root@`%` view vwcoa_dede as
select `af_ukrc`.`tblcoa`.`AccountTypeId`               AS `AccountTypeId`,
       `af_ukrc`.`tblcoa`.`AccountCode`                 AS `AccountCode`,
       `af_ukrc`.`tblcoa`.`isCR`                        AS `isCR`,
       if(((`af_ukrc`.`tblcoa_lang`.`AccountDescription` = '') or
           (`af_ukrc`.`tblcoa_lang`.`AccountDescription` is null)), `af_ukrc`.`tblcoa`.`AccountDescription`,
          `af_ukrc`.`tblcoa_lang`.`AccountDescription`) AS `AccountDescription`
from (`af_ukrc`.`tblcoa` left join `af_ukrc`.`tblcoa_lang`
      on (((`af_ukrc`.`tblcoa`.`AccountTypeId` = `af_ukrc`.`tblcoa_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblcoa`.`AccountCode` = `af_ukrc`.`tblcoa_lang`.`AccountCode`) and
           (`af_ukrc`.`tblcoa`.`isCR` = `af_ukrc`.`tblcoa_lang`.`isCR`) and
           (`af_ukrc`.`tblcoa_lang`.`lang_code` = 'de-DE'))))
where (1 = 1);

create definer = root@`%` view vwcoa_enau as
select `af_ukrc`.`tblcoa`.`AccountTypeId`               AS `AccountTypeId`,
       `af_ukrc`.`tblcoa`.`AccountCode`                 AS `AccountCode`,
       `af_ukrc`.`tblcoa`.`isCR`                        AS `isCR`,
       if(((`af_ukrc`.`tblcoa_lang`.`AccountDescription` = '') or
...
from (`af_ukrc`.`tblcoa` left join `af_ukrc`.`tblcoa_lang`
      on (((`af_ukrc`.`tblcoa`.`AccountTypeId` = `af_ukrc`.`tblcoa_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblcoa`.`AccountCode` = `af_ukrc`.`tblcoa_lang`.`AccountCode`) and
           (`af_ukrc`.`tblcoa`.`isCR` = `af_ukrc`.`tblcoa_lang`.`isCR`) and
           (`af_ukrc`.`tblcoa_lang`.`lang_code` = 'en-AU'))))
where (1 = 1);

create definer = root@`%` view vwcoa_engb as
select `af_ukrc`.`tblcoa`.`AccountTypeId`               AS `AccountTypeId`,
       `af_ukrc`.`tblcoa`.`AccountCode`                 AS `AccountCode`,
       `af_ukrc`.`tblcoa`.`isCR`                        AS `isCR`,
       if(((`af_ukrc`.`tblcoa_lang`.`AccountDescription` = '') or
...
from (`af_ukrc`.`tblcoa` left join `af_ukrc`.`tblcoa_lang`
      on (((`af_ukrc`.`tblcoa`.`AccountTypeId` = `af_ukrc`.`tblcoa_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblcoa`.`AccountCode` = `af_ukrc`.`tblcoa_lang`.`AccountCode`) and
           (`af_ukrc`.`tblcoa`.`isCR` = `af_ukrc`.`tblcoa_lang`.`isCR`) and
           (`af_ukrc`.`tblcoa_lang`.`lang_code` = 'en-GB'))))
where (1 = 1);

create definer = root@`%` view vwcoa_frfr as
select `af_ukrc`.`tblcoa`.`AccountTypeId`               AS `AccountTypeId`,
       `af_ukrc`.`tblcoa`.`AccountCode`                 AS `AccountCode`,
       `af_ukrc`.`tblcoa`.`isCR`                        AS `isCR`,
       if(((`af_ukrc`.`tblcoa_lang`.`AccountDescription` = '') or
...
from (`af_ukrc`.`tblcoa` left join `af_ukrc`.`tblcoa_lang`
      on (((`af_ukrc`.`tblcoa`.`AccountTypeId` = `af_ukrc`.`tblcoa_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblcoa`.`AccountCode` = `af_ukrc`.`tblcoa_lang`.`AccountCode`) and
           (`af_ukrc`.`tblcoa`.`isCR` = `af_ukrc`.`tblcoa_lang`.`isCR`) and
           (`af_ukrc`.`tblcoa_lang`.`lang_code` = 'fr-FR'))))
where (1 = 1);

create definer = root@`%` view vwcoa_nlnl as
select `af_ukrc`.`tblcoa`.`AccountTypeId`               AS `AccountTypeId`,
       `af_ukrc`.`tblcoa`.`AccountCode`                 AS `AccountCode`,
       `af_ukrc`.`tblcoa`.`isCR`                        AS `isCR`,
       if(((`af_ukrc`.`tblcoa_lang`.`AccountDescription` = '') or
...
from (`af_ukrc`.`tblcoa` left join `af_ukrc`.`tblcoa_lang`
      on (((`af_ukrc`.`tblcoa`.`AccountTypeId` = `af_ukrc`.`tblcoa_lang`.`AccountTypeId`) and
           (`af_ukrc`.`tblcoa`.`AccountCode` = `af_ukrc`.`tblcoa_lang`.`AccountCode`) and
           (`af_ukrc`.`tblcoa`.`isCR` = `af_ukrc`.`tblcoa_lang`.`isCR`) and
           (`af_ukrc`.`tblcoa_lang`.`lang_code` = 'nl-NL'))))
where (1 = 1);

create definer = root@`%` view vwformdata_dede as
select `af_ukrc`.`tblformdata`.`FormDataID`      AS `FormDataID`,
       `af_ukrc`.`tblformdata`.`AuditFileNumber` AS `AuditFileNumber`,
       `af_ukrc`.`tblformdata`.`FormRef`         AS `FormRef`,
       `af_ukrc`.`tblformdata`.`RowId`           AS `RowId`,
       `af_ukrc`.`tblformdata`.`Assertions`      AS `Assertions`,
       `af_ukrc`.`tblformdata`.`Completed`       AS `Completed`,
       `af_ukrc`.`tblformdata`.`StaffId`         AS `StaffId`,
       `af_ukrc`.`tblformdata`.`StaffName`       AS `StaffName`,
       `af_ukrc`.`tblformdata`.`DateCompleted`   AS `DateCompleted`,
       `af_ukrc`.`tblformdata`.`Reference`       AS `Reference`,
       `af_ukrc`.`tblformdata`.`Regulations`     AS `Regulations`,
       `af_ukrc`.`tblformdata_lang`.`Comments`   AS `Comments`,
       `af_ukrc`.`tblformdata_lang`.`Comments2`  AS `Comments2`,
       `af_ukrc`.`tblformdata_lang`.`Comments3`  AS `Comments3`,
       `af_ukrc`.`tblformdata`.`YesNo`           AS `YesNo`,
       `af_ukrc`.`tblformdata`.`DataRowId`       AS `DataRowId`
from (`af_ukrc`.`tblformdata` left join `af_ukrc`.`tblformdata_lang`
      on (((`af_ukrc`.`tblformdata`.`RowId` = `af_ukrc`.`tblformdata_lang`.`RowId`) and
           (`af_ukrc`.`tblformdata_lang`.`lang_code` = 'de-DE'))))
where (1 = 1);

-- comment on column vwformdata_dede.Regulations not supported: ISA200, CA 18.3, etc

-- comment on column vwformdata_dede.YesNo not supported: N/A: -1 Yes: 1 No: 0

create definer = root@`%` view vwformdata_enau as
select `af_ukrc`.`tblformdata`.`FormDataID`      AS `FormDataID`,
       `af_ukrc`.`tblformdata`.`AuditFileNumber` AS `AuditFileNumber`,
       `af_ukrc`.`tblformdata`.`FormRef`         AS `FormRef`,
       `af_ukrc`.`tblformdata`.`RowId`           AS `RowId`,
...
from (`af_ukrc`.`tblformdata` left join `af_ukrc`.`tblformdata_lang`
      on (((`af_ukrc`.`tblformdata`.`RowId` = `af_ukrc`.`tblformdata_lang`.`RowId`) and
           (`af_ukrc`.`tblformdata_lang`.`lang_code` = 'en-AU'))))
where (1 = 1);

-- comment on column vwformdata_enau.Regulations not supported: ISA200, CA 18.3, etc

-- comment on column vwformdata_enau.YesNo not supported: N/A: -1 Yes: 1 No: 0

create definer = root@`%` view vwformdata_engb as
select `af_ukrc`.`tblformdata`.`FormDataID`      AS `FormDataID`,
       `af_ukrc`.`tblformdata`.`AuditFileNumber` AS `AuditFileNumber`,
       `af_ukrc`.`tblformdata`.`FormRef`         AS `FormRef`,
       `af_ukrc`.`tblformdata`.`RowId`           AS `RowId`,
...
from (`af_ukrc`.`tblformdata` left join `af_ukrc`.`tblformdata_lang`
      on (((`af_ukrc`.`tblformdata`.`RowId` = `af_ukrc`.`tblformdata_lang`.`RowId`) and
           (`af_ukrc`.`tblformdata_lang`.`lang_code` = 'en-GB'))))
where (1 = 1);

-- comment on column vwformdata_engb.Regulations not supported: ISA200, CA 18.3, etc

-- comment on column vwformdata_engb.YesNo not supported: N/A: -1 Yes: 1 No: 0

create definer = root@`%` view vwformdata_frfr as
select `af_ukrc`.`tblformdata`.`FormDataID`      AS `FormDataID`,
       `af_ukrc`.`tblformdata`.`AuditFileNumber` AS `AuditFileNumber`,
       `af_ukrc`.`tblformdata`.`FormRef`         AS `FormRef`,
       `af_ukrc`.`tblformdata`.`RowId`           AS `RowId`,
...
from (`af_ukrc`.`tblformdata` left join `af_ukrc`.`tblformdata_lang`
      on (((`af_ukrc`.`tblformdata`.`RowId` = `af_ukrc`.`tblformdata_lang`.`RowId`) and
           (`af_ukrc`.`tblformdata_lang`.`lang_code` = 'fr-FR'))))
where (1 = 1);

-- comment on column vwformdata_frfr.Regulations not supported: ISA200, CA 18.3, etc

-- comment on column vwformdata_frfr.YesNo not supported: N/A: -1 Yes: 1 No: 0

create definer = root@`%` view vwformdata_nlnl as
select `af_ukrc`.`tblformdata`.`FormDataID`      AS `FormDataID`,
       `af_ukrc`.`tblformdata`.`AuditFileNumber` AS `AuditFileNumber`,
       `af_ukrc`.`tblformdata`.`FormRef`         AS `FormRef`,
       `af_ukrc`.`tblformdata`.`RowId`           AS `RowId`,
...
from (`af_ukrc`.`tblformdata` left join `af_ukrc`.`tblformdata_lang`
      on (((`af_ukrc`.`tblformdata`.`RowId` = `af_ukrc`.`tblformdata_lang`.`RowId`) and
           (`af_ukrc`.`tblformdata_lang`.`lang_code` = 'nl-NL'))))
where (1 = 1);

-- comment on column vwformdata_nlnl.Regulations not supported: ISA200, CA 18.3, etc

-- comment on column vwformdata_nlnl.YesNo not supported: N/A: -1 Yes: 1 No: 0

create definer = root@`%` view vwformdatarow_cygb as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
       `af_ukrc`.`tblformdatarow`.`Assertion`                                                          AS `Assertion`,
       `af_ukrc`.`tblformdatarow`.`DefaultFormRef`                                                     AS `DefaultFormRef`,
       `af_ukrc`.`tblformdatarow`.`Recordable`                                                         AS `Recordable`,
       `af_ukrc`.`tblformdatarow`.`RowRank`                                                            AS `RowRank`,
       `af_ukrc`.`tblformdatarow`.`Ref1`                                                               AS `Ref1`,
       `af_ukrc`.`tblformdatarow`.`Number1`                                                            AS `Number1`,
       `af_ukrc`.`tblformdatarow`.`Ref2`                                                               AS `Ref2`,
       `af_ukrc`.`tblformdatarow`.`Number2`                                                            AS `Number2`,
       `af_ukrc`.`tblformdatarow`.`VersionNumber`                                                      AS `VersionNumber`,
       `af_ukrc`.`tblformdatarow`.`dbctrlrowid`                                                        AS `dbctrlrowid`,
       `af_ukrc`.`tblformdatarow`.`dbctrlrowtype`                                                      AS `dbctrlrowtype`,
       `af_ukrc`.`tblformdatarow`.`ParentId`                                                           AS `ParentId`
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'cy-GB'))))
where (1 = 1);

-- comment on column vwformdatarow_cygb.VersionNumber not supported: version number

-- comment on column vwformdatarow_cygb.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_cygb.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_cygb.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_cz as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'cz'))))
where (1 = 1);

-- comment on column vwformdatarow_cz.VersionNumber not supported: version number

-- comment on column vwformdatarow_cz.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_cz.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_cz.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_czcz as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'cz-CZ'))))
where (1 = 1);

-- comment on column vwformdatarow_czcz.VersionNumber not supported: version number

-- comment on column vwformdatarow_czcz.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_czcz.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_czcz.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_de as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'de'))))
where (1 = 1);

-- comment on column vwformdatarow_de.VersionNumber not supported: version number

-- comment on column vwformdatarow_de.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_de.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_de.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_deat as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'de-AT'))))
where (1 = 1);

-- comment on column vwformdatarow_deat.VersionNumber not supported: version number

-- comment on column vwformdatarow_deat.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_deat.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_deat.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_dech as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'de-CH'))))
where (1 = 1);

-- comment on column vwformdatarow_dech.VersionNumber not supported: version number

-- comment on column vwformdatarow_dech.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_dech.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_dech.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_dede as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                              AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                          AS `DataSectionId`,
       if(((`af_ukrc`.`tblformdatarow_lang`.`RowName` = '') or (`af_ukrc`.`tblformdatarow_lang`.`RowName` is null)),
          `af_ukrc`.`tblformdatarow`.`RowName`, `af_ukrc`.`tblformdatarow_lang`.`RowName`) AS `RowName`,
       if(((`af_ukrc`.`tblformdatarow_lang`.`Description` = '') or
           (`af_ukrc`.`tblformdatarow_lang`.`Description` is null)), `af_ukrc`.`tblformdatarow`.`Description`,
          `af_ukrc`.`tblformdatarow_lang`.`Description`)                                   AS `Description`,
       `af_ukrc`.`tblformdatarow`.`Assertion`                                              AS `Assertion`,
       `af_ukrc`.`tblformdatarow`.`DefaultFormRef`                                         AS `DefaultFormRef`,
       `af_ukrc`.`tblformdatarow`.`Recordable`                                             AS `Recordable`,
       `af_ukrc`.`tblformdatarow`.`RowRank`                                                AS `RowRank`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'de-DE'))))
where (1 = 1);

-- comment on column vwformdatarow_dede.VersionNumber not supported: version number

-- comment on column vwformdatarow_dede.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_dede.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_dede.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_deli as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'de-LI'))))
where (1 = 1);

-- comment on column vwformdatarow_deli.VersionNumber not supported: version number

-- comment on column vwformdatarow_deli.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_deli.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_deli.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_delu as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'de-LU'))))
where (1 = 1);

-- comment on column vwformdatarow_delu.VersionNumber not supported: version number

-- comment on column vwformdatarow_delu.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_delu.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_delu.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_enau as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                              AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                          AS `DataSectionId`,
       if(((`af_ukrc`.`tblformdatarow_lang`.`RowName` = '') or (`af_ukrc`.`tblformdatarow_lang`.`RowName` is null)),
          `af_ukrc`.`tblformdatarow`.`RowName`, `af_ukrc`.`tblformdatarow_lang`.`RowName`) AS `RowName`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'en-AU'))))
where (1 = 1);

-- comment on column vwformdatarow_enau.VersionNumber not supported: version number

-- comment on column vwformdatarow_enau.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_enau.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_enau.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_engb as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                              AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                          AS `DataSectionId`,
       if(((`af_ukrc`.`tblformdatarow_lang`.`RowName` = '') or (`af_ukrc`.`tblformdatarow_lang`.`RowName` is null)),
          `af_ukrc`.`tblformdatarow`.`RowName`, `af_ukrc`.`tblformdatarow_lang`.`RowName`) AS `RowName`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'en-GB'))))
where (1 = 1);

-- comment on column vwformdatarow_engb.VersionNumber not supported: version number

-- comment on column vwformdatarow_engb.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_engb.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_engb.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_frbe as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'fr-BE'))))
where (1 = 1);

-- comment on column vwformdatarow_frbe.VersionNumber not supported: version number

-- comment on column vwformdatarow_frbe.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_frbe.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_frbe.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_frch as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'fr-CH'))))
where (1 = 1);

-- comment on column vwformdatarow_frch.VersionNumber not supported: version number

-- comment on column vwformdatarow_frch.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_frch.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_frch.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_frfr as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                              AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                          AS `DataSectionId`,
       if(((`af_ukrc`.`tblformdatarow_lang`.`RowName` = '') or (`af_ukrc`.`tblformdatarow_lang`.`RowName` is null)),
          `af_ukrc`.`tblformdatarow`.`RowName`, `af_ukrc`.`tblformdatarow_lang`.`RowName`) AS `RowName`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'fr-FR'))))
where (1 = 1);

-- comment on column vwformdatarow_frfr.VersionNumber not supported: version number

-- comment on column vwformdatarow_frfr.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_frfr.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_frfr.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_frlu as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'fr-LU'))))
where (1 = 1);

-- comment on column vwformdatarow_frlu.VersionNumber not supported: version number

-- comment on column vwformdatarow_frlu.dbctrlrowid not supported: from dbcontroller

-- comment on column vwformdatarow_frlu.dbctrlrowtype not supported: tblformcontentrow.RowType

-- comment on column vwformdatarow_frlu.ParentId not supported: tblformdatarow.DataRowId for subprocedures

create definer = root@`%` view vwformdatarow_fynl as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'fy-NL'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_it as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'it'))))
where (1 = 1);
create definer = root@`%` view vwformdatarow_itch as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'it-CH'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_itit as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'it-IT'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_lblu as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'lb-LU'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_nlbe as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'nl-BE'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_nlnl as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                              AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                          AS `DataSectionId`,
       if(((`af_ukrc`.`tblformdatarow_lang`.`RowName` = '') or (`af_ukrc`.`tblformdatarow_lang`.`RowName` is null)),
          `af_ukrc`.`tblformdatarow`.`RowName`, `af_ukrc`.`tblformdatarow_lang`.`RowName`) AS `RowName`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'nl-NL'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_pl as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'pl'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_plpl as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'pl-PL'))))
where (1 = 1);
create definer = root@`%` view vwformdatarow_rmch as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'rm-CH'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_sk as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'sk'))))
where (1 = 1);

create definer = root@`%` view vwformdatarow_sksk as
select `af_ukrc`.`tblformdatarow`.`DataRowId`                                                          AS `DataRowId`,
       `af_ukrc`.`tblformdatarow`.`DataSectionId`                                                      AS `DataSectionId`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`RowName`, `af_ukrc`.`tblformdatarow`.`RowName`)         AS `RowName`,
       ifnull(`af_ukrc`.`tblformdatarow_lang`.`Description`, `af_ukrc`.`tblformdatarow`.`Description`) AS `Description`,
...
from (`af_ukrc`.`tblformdatarow` left join `af_ukrc`.`tblformdatarow_lang`
      on (((`af_ukrc`.`tblformdatarow`.`DataRowId` = `af_ukrc`.`tblformdatarow_lang`.`DataRowId`) and
           (`af_ukrc`.`tblformdatarow_lang`.`lang_code` = 'sk-SK'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_cygb as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
              `af_ukrc`.`tblformdatasection`.`Title`)                                                                AS `Title`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`SubTitle`,
              `af_ukrc`.`tblformdatasection`.`SubTitle`)                                                             AS `SubTitle`,
       `af_ukrc`.`tblformdatasection`.`FormId`                                                                       AS `FormId`,
       `af_ukrc`.`tblformdatasection`.`SectionRank`                                                                  AS `SectionRank`,
       `af_ukrc`.`tblformdatasection`.`VersionNumber`                                                                AS `VersionNumber`,
       `af_ukrc`.`tblformdatasection`.`dbctrlsectionid`                                                              AS `dbctrlsectionid`,
       `af_ukrc`.`tblformdatasection`.`dbctrlsectiontype`                                                            AS `dbctrlsectiontype`,
       `af_ukrc`.`tblformdatasection`.`SectionDefaultVal`                                                            AS `SectionDefaultVal`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`SectionComment`,
              `af_ukrc`.`tblformdatasection`.`SectionComment`)                                                       AS `SectionComment`,
       `af_ukrc`.`tblformdatasection`.`SectionTag`                                                                   AS `SectionTag`,
       `af_ukrc`.`tblformdatasection`.`ParentId`                                                                     AS `ParentId`,
       `af_ukrc`.`tblformdatasection`.`Reference`                                                                    AS `Reference`,
       `af_ukrc`.`tblformdatasection`.`DisplayTitle`                                                                 AS `DisplayTitle`
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'cy-GB'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_cz as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'cz'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_czcz as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'cz-CZ'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_de as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'de'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_deat as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'de-AT'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_dech as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'de-CH'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_dede as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                            AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                          AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                  AS `FormRef`,
       if(((`af_ukrc`.`tblformdatasection_lang`.`Title` = '') or (`af_ukrc`.`tblformdatasection_lang`.`Title` is null)),
          `af_ukrc`.`tblformdatasection`.`Title`,
          `af_ukrc`.`tblformdatasection_lang`.`Title`)                                                           AS `Title`,
       if(((`af_ukrc`.`tblformdatasection_lang`.`SubTitle` = '') or
           (`af_ukrc`.`tblformdatasection_lang`.`SubTitle` is null)), `af_ukrc`.`tblformdatasection`.`SubTitle`,
          `af_ukrc`.`tblformdatasection_lang`.`SubTitle`)                                                        AS `SubTitle`,
       `af_ukrc`.`tblformdatasection`.`FormId`                                                                   AS `FormId`,
       `af_ukrc`.`tblformdatasection`.`SectionRank`                                                              AS `SectionRank`,
       `af_ukrc`.`tblformdatasection`.`VersionNumber`                                                            AS `VersionNumber`,
       `af_ukrc`.`tblformdatasection`.`dbctrlsectionid`                                                          AS `dbctrlsectionid`,
       `af_ukrc`.`tblformdatasection`.`dbctrlsectiontype`                                                        AS `dbctrlsectiontype`,
       `af_ukrc`.`tblformdatasection`.`SectionDefaultVal`                                                        AS `SectionDefaultVal`,
       if(((`af_ukrc`.`tblformdatasection_lang`.`SectionComment` = '') or
           (`af_ukrc`.`tblformdatasection_lang`.`SectionComment` is null)),
          `af_ukrc`.`tblformdatasection`.`SectionComment`,
          `af_ukrc`.`tblformdatasection_lang`.`SectionComment`)                                                  AS `SectionComment`,
       `af_ukrc`.`tblformdatasection`.`SectionTag`                                                               AS `SectionTag`,
       `af_ukrc`.`tblformdatasection`.`ParentId`                                                                 AS `ParentId`,
       `af_ukrc`.`tblformdatasection`.`Reference`                                                                AS `Reference`,
       `af_ukrc`.`tblformdatasection`.`DisplayTitle`                                                             AS `DisplayTitle`
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'de-DE'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_deli as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'de-LI'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_delu as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'de-LU'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_enau as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                            AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                          AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                  AS `FormRef`,
       if(((`af_ukrc`.`tblformdatasection_lang`.`Title` = '') or (`af_ukrc`.`tblformdatasection_lang`.`Title` is null)),
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'en-AU'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_engb as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                            AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                          AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                  AS `FormRef`,
       if(((`af_ukrc`.`tblformdatasection_lang`.`Title` = '') or (`af_ukrc`.`tblformdatasection_lang`.`Title` is null)),
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'en-GB'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_frbe as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'fr-BE'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_frch as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'fr-CH'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_frfr as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                            AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                          AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                  AS `FormRef`,
       if(((`af_ukrc`.`tblformdatasection_lang`.`Title` = '') or (`af_ukrc`.`tblformdatasection_lang`.`Title` is null)),
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'fr-FR'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_frlu as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'fr-LU'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_fynl as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'fy-NL'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_it as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'it'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_itch as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'it-CH'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_itit as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'it-IT'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_lblu as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'lb-LU'))))
where (1 = 1);

create definer = root@`%` view vwformdatasection_nlbe as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'nl-BE'))))
where (1 = 1);


create definer = root@`%` view vwformdatasection_nlnl as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                            AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                          AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                  AS `FormRef`,
       if(((`af_ukrc`.`tblformdatasection_lang`.`Title` = '') or (`af_ukrc`.`tblformdatasection_lang`.`Title` is null)),
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'nl-NL'))))
where (1 = 1);


create definer = root@`%` view vwformdatasection_pl as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'pl'))))
where (1 = 1);


create definer = root@`%` view vwformdatasection_plpl as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'pl-PL'))))
where (1 = 1);


create definer = root@`%` view vwformdatasection_rmch as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'rm-CH'))))
where (1 = 1);


create definer = root@`%` view vwformdatasection_sk as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'sk'))))
where (1 = 1);


create definer = root@`%` view vwformdatasection_sksk as
select `af_ukrc`.`tblformdatasection`.`DataSectionId`                                                                AS `DataSectionId`,
       `af_ukrc`.`tblformdatasection`.`AuditFileNumber`                                                              AS `AuditFileNumber`,
       `af_ukrc`.`tblformdatasection`.`FormRef`                                                                      AS `FormRef`,
       ifnull(`af_ukrc`.`tblformdatasection_lang`.`Title`,
...
from (`af_ukrc`.`tblformdatasection` left join `af_ukrc`.`tblformdatasection_lang`
      on (((`af_ukrc`.`tblformdatasection`.`DataSectionId` = `af_ukrc`.`tblformdatasection_lang`.`DataSectionId`) and
           (`af_ukrc`.`tblformdatasection_lang`.`lang_code` = 'sk-SK'))))
where (1 = 1);
